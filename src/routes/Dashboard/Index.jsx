  ...
  return(
    <>
      ...
      <div className="flex min-[840px]:hidden w-full fixed top-0 left-0 justify-between items-center bg-[#272C49] px-[20px] sm:px-[35px] py-3 z-30">
        <button id="dashboard_open_modal_btn">
          <svg 
        ...
        {/* begin::Mobile Modal */}
        <div className="parent_dashboard_mobile_modal opacity-0 invisible fixed top-0 left-0 w-full h-screen bg-black/60 duration-500 z-[999]">
          <div className="dashboard_mobile_modal translate-x-[-100%] relative bg-[#272C49] w-full max-w-[280px] h-screen flex flex-col duration-300">
            <div className="w-full bg-[#1e2238] py-[15px] px-5">
              <svg
                id="dashboard_close_modal_btn"
            ...
            <nav className="w-full">
              <ul className="flex flex-col justify-between items-center">
                <li className="w-full">
                  <a href="#" className="block w-full flex justify-start items-center gap-x-4 px-5 py-5 border-b border-white/20">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="23"
                      height="24"
                ...
                <li className="w-full">
                  <a href="baby-data.html" className="block w-full flex justify-start items-center gap-x-4 px-5 py-5 border-b border-white/20">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="23"
                      height="24"
                    ...
                    <span className="text-white text-[17px]">Baby's Data</span>
                  </a>
                </li>
                <li className="w-full">
                  <a href="baby-chart.html" className="block w-full flex justify-start items-center gap-x-4 px-5 py-5 border-b border-white/20">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="23"
                      height="28"
                ...
                <li className="w-full">
                  <a href="immunization.html" className="block w-full flex justify-start items-center gap-x-4 px-5 py-5 border-b border-white/20">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="23"
                      height="24"
                    ...
                    <span className="text-white text-[17px]">Immunization</span>
                  </a>
                </li>
              </ul>
            </nav>

            <button className="logout_btn mt-auto block w-full flex justify-start items-center gap-x-4 px-5 py-5">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="23"
                height="23"
        ...
        <div className="flex flex-col xl:flex-row justify-between w-full h-auto xl:h-screen px-[20px] sm:px-[35px] min-[840px]:pl-[55px] min-[840px]:pr-[55px] xl:pr-0 gap-x-[55px] select-none">
          ...
          <div className="py-10 flex flex-col w-full gap-y-[30px] xl:gap-y-[20px] min-[1600px]:gap-y-[30px]">
            ...
            <div className="flex flex-col gap-y-3">
              <div className="flex flex-col min-[840px]:flex-row justify-between items-start min-[840px]:items-center">
                <h3 className="font-bold text-[#272C49]">Dashboard</h3>
                <span id="last_updated_el" className="text-xs text-[#898989]">-</span>
              </div>
    
              <div className="flex flex-col min-[840px]:flex-row flex-between gap-x-[25px] gap-y-[20px]">
                {/* Berat (Active) */}
                <a href="baby-chart.html?chart=berat" className="w-full block">
                ...
                {/* Tinggi (Active) */}
                <a href="baby-chart.html?chart=tinggi" className="w-full block">
                ...
                {/* L. Kepala (Active) */}
                <a href="baby-chart.html?chart=lingkar_kepala" className="w-full block">
            ...
            <div className="flex flex-col gap-y-3">
              <div className="flex flex-col min-[840px]:flex-row justify-between items-start min-[840px]:items-center">
                <h3 className="font-bold text-[#272C49]">Kebutuhan Harian</h3>
                <span className="text-xs text-[#898989]">berdasarkan data terakhir yang diinput</span>
              </div>
              ...
              <div className="flex flex-col min-[840px]:flex-row flex-between gap-x-[25px] gap-y-[20px]">
                <div className="flex flex-col w-full bg-white justify-center text-center p-[32px] rounded-2xl gap-y-2 shadow-[0_2px_4px_0px_rgba(0,0,0,0.10)]">
                  <span className="text-[#898989]">Cairan</span>
                ...
                <div className="flex flex-col w-full bg-white justify-center text-center p-[32px] rounded-2xl gap-y-2 shadow-[0_2px_4px_0px_rgba(0,0,0,0.10)]">
                  <span className="text-[#898989]">Tidur</span>
                  <div className="w-full flex justify-center items-end gap-1 text-[#36455B]">
                    <h1 className="text-2xl font-bold">14 - 17</h1>
                    <span className="text-lg">jam</span>
                  </div>
                </div>
                <div className="flex flex-col w-full bg-white justify-center text-center p-[32px] rounded-2xl gap-y-2 shadow-[0_2px_4px_0px_rgba(0,0,0,0.10)]">
                  <span className="text-[#898989]">Aktivitas</span>
                  <div className="w-full flex justify-center items-end gap-1 text-[#36455B]">
                    <h1 className="text-2xl font-bold">Lebih 30</h1>
          ...
          <div className="p-6 sm:p-8 min-[840px]:p-10 flex flex-col w-full xl:max-w-[435px] bg-white shadow-[0_4px_8px_0px_rgba(0,0,0,0.10)] gap-y-10 xl:gap-y-[14px] min-[1600px]:gap-y-[30px] rounded-2xl xl:rounded-none">
            <div className="flex items-center gap-x-3">
              <img src="assets/images/brenda-s.png" alt="User's Profile Picture" className="w-[50px] h-[50px] shrink-0 rounded-full"></img>
              <div>
            ...
            <div className="flex flex-col gap-y-3">
              ...
              <div className="flex flex-col justify-center items-center gap-y-4">
                ...
                <div className="w-full px-5 py-4 rounded-xl border border-[#D1D9E2]">
                  <h3 className="font-bold text-[#36455B]">BCG</h3>
                  <div className="flex items-center gap-x-1 mt-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="11" viewBox="0 0 10 11" fill="none">
                      <path d="M5 0.5C6.32608 0.5 7.59785 1.02678 8.53553 1.96447C9.47322 2.90215 10 4.17392 10 5.5C10 6.82608 9.47322 8.09785 8.53553 9.03553C7.59785 9.97322 6.32608 10.5 5 10.5C3.67392 10.5 2.40215 9.97322 1.46447 9.03553C0.526784 8.09785 0 6.82608 0 5.5C0 4.17392 0.526784 2.90215 1.46447 1.96447C2.40215 1.02678 3.67392 0.5 5 0.5ZM4.53125 2.84375V5.5C4.53125 5.65625 4.60938 5.80273 4.74023 5.89062L6.61523 7.14062C6.83008 7.28516 7.12109 7.22656 7.26562 7.00977C7.41016 6.79297 7.35156 6.50391 7.13477 6.35938L5.46875 5.25V2.84375C5.46875 2.58398 5.25977 2.375 5 2.375C4.74023 2.375 4.53125 2.58398 4.53125 2.84375Z" fill="#898989"/>
                    </svg>
