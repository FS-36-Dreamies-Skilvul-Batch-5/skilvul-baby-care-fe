...
export default function UserCard(props) {
  const { user_number, id, name, username, email, img_url, role } = props;
  ...
  return (
    <>
      <tr className="border-b border-[#D1D9E2]">
        <td className="text-[#898989] text-center py-3.5">{user_number + 1}</td>
        ...
        <td className="text-[#898989] text-center py-3.5">
          <span
            ...
            } font-bold text-sm text-white px-5 py-[6px] rounded-lg`}
          >
            {role}
          </span>
        </td>
