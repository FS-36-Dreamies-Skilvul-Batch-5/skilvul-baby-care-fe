          ...
          <div className="dashboard_mobile_modal translate-x-[-100%] relative bg-[#272C49] w-full max-w-[280px] h-screen flex flex-col duration-300">
            ...
            <nav className="w-full">
              <ul className="flex flex-col justify-between items-center">
                <li className="w-full">
                  <a href="#" className="w-full flex justify-start items-center gap-x-4 px-5 py-5 border-b border-white/20">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="23"
                      height="24"
                ...
                <li className="w-full">
                  <a href="baby-data.html" className="w-full flex justify-start items-center gap-x-4 px-5 py-5 border-b border-white/20">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="23"
                      height="24"
                ...
                <li className="w-full">
                  <a href="baby-chart.html" className="w-full flex justify-start items-center gap-x-4 px-5 py-5 border-b border-white/20">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="23"
                      height="28"
                ...
                <li className="w-full">
                  <a href="immunization.html" className="w-full flex justify-start items-center gap-x-4 px-5 py-5 border-b border-white/20">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="23"
                      height="24"
            ...
            <button className="logout_btn mt-auto w-full flex justify-start items-center gap-x-4 px-5 py-5">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="23"
                height="23"
